...
const SERVER_ID = urlParams.get('serverId') || '4pkrp9'; // Add Your server ID here Just Replace 'y4lg95' with your server ID (y4lg95 is a Fivem b299 server ID example)
